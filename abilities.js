	...
	abilities.insertAdjacentHTML(
		...
		`
			<div class="ability outline" id="ability${idx}.0.0">
				...
				<div class="input-group"><input class="form-control" type="number" name="ability${idx}.0.0cooldown" id="ability${idx}.0.0cooldown" min="0" value="0"/><span class="input-group-text">turn(s)</span></div>
				...
				<div id="ability${idx}.0.0intllockvaluecontainer" class="intllockinput" style="display:none">
					...
					<input class="form-control" type="number" name="ability${idx}.0.0intllockvalue" id="ability${idx}.0.0intllockvalue" />
				</div>
				<div class="seperatorinputs"></div>
	...
	dynamicinputs.insertAdjacentHTML(
		...
		`
			...
			<select class="form-select" name="ability${idx}.${subidx}.${subsubidx}form" id="ability${idx}.${subidx}.${subsubidx}form" onchange="abilityDamageFormChange(this)" required>
				...
				<option value="abilitydamagekill">Elimination</option>
			</select>
		`
	);
	dynamicinputs.insertAdjacentHTML(
...
function abilityDamageFormChange(dropdown) {
	...
	if (
		value === "abilitydamagedirect" ||
		value === "abilitydamageintelligence"
	) {
		parameters.insertAdjacentHTML(
			"afterbegin",
			`
				<div class="seperatorinputs"></div>
				<label for="ability${idx}.${subidx}.${subsubidx}damage" class="form-label">Damage</label>
				<input class="form-control" type="number" name="ability${idx}.${subidx}.${subsubidx}damage" id="ability${idx}.${subidx}.${subsubidx}damage" min="1" required />
			`
		);
		...
		parameters.insertAdjacentHTML(
			...
			`
				...
				<div class="input-group"><input class="form-control" type="number" name="ability${idx}.${subidx}.${subsubidx}debuff" id="ability${idx}.${subidx}.${subsubidx}debuff" min="1" max="100" required/><span class="input-group-text" id="ability${idx}.${subidx}.${subsubidx}span">%</span></div>
				<div class="seperatorinputs"></div>
				<label for="ability${idx}.${subidx}.${subsubidx}lastsfor" class="form-label">Lasts for</label>
				<div class="input-group"><input class="form-control" type="number" name="ability${idx}.${subidx}.${subsubidx}lastsfor" id="ability${idx}.${subidx}.${subsubidx}lastsfor" min="1" required /><span class="input-group-text">turn(s)</span></div>
			`
		);
	}

	if (value !== "abilitydamagekill") {
		parameters.insertAdjacentHTML(
			"beforeend",
			`
				<div class="seperatorinputs"></div>
				<label for="ability${idx}.${subidx}.${subsubidx}target" class="form-label">Apply to whole deck?</label>
				<div class="form-check form-switch"><input class="form-check-input" type="checkbox" role="switch" name="ability${idx}.${subidx}.${subsubidx}target" id="ability${idx}.${subidx}.${subsubidx}target" /></div>
			`
		);
	}
}
...
function abilityDamageDebuffTypeChange(radio) {
	...
	if (value === "percent") {
		...
		span.parentElement.classList = "input-group";
	} else if (value === "fixed") {
	...
	if (value === "abilitysupporthealing") {
		parameters.insertAdjacentHTML(
			...
			`
				...
				<input class="form-control" type="number" name="ability${idx}.${subidx}.${subsubidx}heal" id="ability${idx}.${subidx}.${subsubidx}heal" min="1" required />
			`
		);
		...
		parameters.insertAdjacentHTML(
			...
			`
				...
				<input class="form-control" type="number" name="ability${idx}.${subidx}.${subsubidx}increase" id="ability${idx}.${subidx}.${subsubidx}increase" min="1" required />
			`
		);
		...
		parameters.insertAdjacentHTML(
			...
			`
				...
				<div class="input-group"><input class="form-control" type="number" name="ability${idx}.${subidx}.${subsubidx}boost" id="ability${idx}.${subidx}.${subsubidx}boost" min="1" required/><span class="input-group-text" id="ability${idx}.${subidx}.${subsubidx}span">%</span></div>
				<div class="seperatorinputs"></div>
				<label for="ability${idx}.${subidx}.${subsubidx}lastsfor" class="form-label">Lasts for</label>
				<div class="input-group"><input class="form-control" type="number" name="ability${idx}.${subidx}.${subsubidx}lastsfor" id="ability${idx}.${subidx}.${subsubidx}lastsfor" min="1" required /><span class="input-group-text">turn(s)</span></div>
			`
